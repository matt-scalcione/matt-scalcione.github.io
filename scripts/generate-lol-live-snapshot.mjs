...
const outputPath = path.join(repoRoot, "assets", "provider-snapshots", "lol-live.json");
...
async function main() {
  ...
  process.stdout.write(`Wrote LoL live snapshot with ${rows.length} rows to ${outputPath}\n`);
}
